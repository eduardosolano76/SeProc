...
public class SolicitudProyecto {
    ...
    private String tipoObra; // Edificación/Barda perimetral/Techado/Pisos
    ...
    public Long getIdUsuarioContratista() { return idUsuarioContratista; }
    public void setIdUsuarioContratista(Long idUsuarioContratista) { this.idUsuarioContratista = idUsuarioContratista; }

    public Long getIdUsuarioCentral() { return idUsuarioCentral; }
    public void setIdUsuarioCentral(Long idUsuarioCentral) { this.idUsuarioCentral = idUsuarioCentral; }
    ...
    public String getCct1() { return cct1; }
    public void setCct1(String cct1) { this.cct1 = cct1; }

    public String getCct2() { return cct2; }
    public void setCct2(String cct2) { this.cct2 = cct2; }
    ...
    public CatLocalidad getLocalidad() { return localidad; }
    public void setLocalidad(CatLocalidad localidad) { this.localidad = localidad; }
    ...
    public String getResponsableInmueble() { return responsableInmueble; }
    public void setResponsableInmueble(String responsableInmueble) { this.responsableInmueble = responsableInmueble; }

    public String getContacto() { return contacto; }
    public void setContacto(String contacto) { this.contacto = contacto; }

    public Integer getNumInmueblesEvaluar() { return numInmueblesEvaluar; }
    public void setNumInmueblesEvaluar(Integer numInmueblesEvaluar) { this.numInmueblesEvaluar = numInmueblesEvaluar; }

    public Integer getNumEntreEjes() { return numEntreEjes; }
    public void setNumEntreEjes(Integer numEntreEjes) { this.numEntreEjes = numEntreEjes; }
